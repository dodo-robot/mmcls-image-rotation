...
deploy_models_to_minio:
	get_minio_pod=$(KUBECTL) describe pods -n ${NAMESPACE} | grep Name.*minio | awk 'NR==1 {print $$2}'
	minio = eval $$get_minio_pod
	get_model_name=ls model  | awk 'NR==1 {print $$1}'
	model_name = eval $$get_model_name
